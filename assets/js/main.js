let wordList = ['casa', 'fígado','abacaxi', 'livro', 'pão', 'sapato', 'abóbora','cadeira', 'tomate', 'mouse', 'polícia','estômago','teclado', 'maçã', 'caneta', 'tesoura']; // lista fixa de palavras iniciais
